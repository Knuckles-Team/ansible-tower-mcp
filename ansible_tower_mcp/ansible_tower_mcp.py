...
def ansible_tower_mcp():
    ...
    parser = argparse.ArgumentParser(add_help=False, description="Ansible Tower MCP")
...
def usage():
    print(
        f"Ansible Tower Mcp ({__version__}): Ansible Tower MCP\n\n"
        "Usage:\n"
