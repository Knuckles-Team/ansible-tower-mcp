...
def get_skills_path() -> str:
    skills_dir = files("ansible_tower_mcp") / "skills"
...
def get_mcp_config_path() -> str:
    mcp_config_file = files("ansible_tower_mcp") / "mcp_config.json"
                ...
                try:
                    with open(skill_file, "r") as f:
                        ...
                        if content.startswith("---"):
                            ...
                            tag_name = skill_id.replace("ansible-tower-mcp-", "")
                            tags = ["ansible-tower", tag_name]
