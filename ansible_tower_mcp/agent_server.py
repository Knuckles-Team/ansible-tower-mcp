...
def agent_server():
    ...
    CONCEPT:AT-OS.config.bootstraps-creates-pydantic-ai: Bootstraps and creates the Pydantic AI agent server with auto-discovery configs.
    """
    ...
    DEFAULT_AGENT_DESCRIPTION = os.getenv(
        ...
        meta.get(
            "description",
            "AI agent for Ansible Tower management.",
        ),
    )
