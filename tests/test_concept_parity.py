...
# Paths
ROOT_DIR = '/home/apps/workspace/agent-packages/agents/ansible-tower-mcp'
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in ansible-tower-mcp
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in ansible-tower-mcp but are NOT registered "
